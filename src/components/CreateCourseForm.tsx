        ...
        >
          ...
          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
            <Button
              type="button"
              variant="secondary"
              className="h-10 w-full border-2 border-green-500 font-medium transition-colors hover:cursor-pointer hover:bg-green-50 dark:hover:bg-green-900/20"
              onClick={() => {
            ...
            <Button
              type="button"
              variant="secondary"
              className="h-10 w-full border-2 border-red-500 font-medium transition-colors hover:cursor-pointer hover:bg-red-50 dark:hover:bg-red-900/20"
              onClick={() => {
